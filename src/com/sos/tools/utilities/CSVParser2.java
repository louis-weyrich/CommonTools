 ...
 */
public class CSVParser2 implements Iterable <RowSet<String>>
{
    ...
    public CSVParser2(File file, String [] headers, char delimiter) throws FileNotFoundException, ParseException{
     ...
     * 
     */
    public CSVParser2(File file, char delimiter, boolean hasHeaders) throws FileNotFoundException, ParseException
    {
